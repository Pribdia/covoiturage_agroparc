...
<!-- BODY -->
<div class="container" >
  <center><h1>Proposer son trajet:</h1>
    <div class="">
        <div class="">
        ...
        <form method="get" action="loca_prop_2.php" >
        ...
        <select class="form-control" id="sel1" name="DEP">
            ...
            <a href="loca_prop_2.php"><button class="btn btn-default"NAME="continuer" VALUE="Continuer" type="submit"></a>
              Continuer
            </button>
            </form>
            </div>
